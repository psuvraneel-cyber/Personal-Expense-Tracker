...
void main() {
  ...
  group('HIGH-4: Persistence & Sync Integration Tests', () {
    test(
      '1. Proximity deduplication matches inside 30s window with same merchant and rejects outside window or different merchant/sender',
      () async {
    ...
    test(
      '2. UserFeedbackStore persistence round-trip survives simulated cold start',
      () async {
    ...
    test(
      '3. Watermark validation rejects future-dated, negative, and >30-day old timestamps',
      () async {
    ...
    test(
      '4. insertBatch is atomic: failure mid-batch rolls back completely (all-or-nothing)',
      () async {
