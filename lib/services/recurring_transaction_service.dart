...
class RecurringTransactionService {
  ...
  Future<List<TransactionRecord>> generateDueOccurrences({
    ...
    final dueRules =
        await _repository.getDueRules(referenceTime, userId: userId);
  ...
  Future<void> skipOccurrence({
    ...
    DateTime? nextDate;
    if (rule != null &&
        rule.nextOccurrenceDate.isAtSameMomentAs(scheduledDate)) {
  ...
  Future<void> deleteRuleAndAllOccurrences(String ruleId,
      {String? userId}) async {
