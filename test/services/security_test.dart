...
void main() {
  ...
  group('FirebaseAuthService Secure Migration Tests', () {
    test(
      'tryRestoreSession migrates legacy SharedPreferences credentials to SecureStorage',
      () async {
  ...
  group('DatabaseHelper Encryption Gating Tests', () {
    test(
      'isSqlCipherSupported returns false when using FFI on standard Windows test environment',
      () async {
